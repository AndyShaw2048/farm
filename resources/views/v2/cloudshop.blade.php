...
<head>
    ...
    <link rel="stylesheet" href="{{url('v2/css/cloudShop.css')}}">
...
<div class="am-g">
    <div class="am-slider am-slider-default" data-am-flexslider id="demo-slider-0">
        <ul class="am-slides">
            <li>
                <img src="{{url('v2/img/cloudShop-img/6P0A3676.jpg')}}" alt="" width="100%">
            </li>
            <li>
                <img src="{{url('v2/img/cloudShop-img/6P0A3754.jpg')}}" alt="" width="100%">
            </li>
            <li>
                <img src="{{url('v2/img/cloudShop-img/6P0A3829.jpg')}}" alt="" width="100%">
            <li>
                <img src="{{url('v2/img/cloudShop-img/6P0A3972.jpg')}}" alt="" width="100%">
            </li>
        </ul>
    </div>
</div>
...
<div class="am-g product">
    <p class="eng-word">PRODUCTS</p>
